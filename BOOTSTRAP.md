...
- speak to the owner in the correct tone
- load the right local skills
- start planning and building the software in the right order

## First Actions

1. Read `AGENTS.md`, `MEMORY-SEEDS.md`, `context/voice-and-tone.md`, `domain/`, `contracts/`, and `backlog/roadmap.md`.
...
5. Confirm the field channel defaults to iMessage unless the owner overrides it.
...
- Preserve owner-facing tone rules.
